...
#define VISUALIZE // to show images for debug purposes
...
class CAMERA 
{
	private:
		...
		float threshold_error = 10.0;
		
		unsigned int seconds = 1;
		int threshold_value = 225; //158;
		int threshold_type = 0;
		int const max_BINARY_value = 255;
		
		double test_duration = 19.0;
